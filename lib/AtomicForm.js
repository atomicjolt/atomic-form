      ...
      if (this.props.updateFormData) {
        ...
        _lodash2["default"].forEach(this.refs, (function (val, key) {
          ...
          if (!_lodash2["default"].isEmpty(value) || _lodash2["default"].isBoolean(value)) {
            _reactDom2["default"].findDOMNode(val).value = value;
          }
        }).bind(this));
      }
    }
    ...
    value: function formData() {
      ...
      if (this.props.collectFormData) {
        ...
        _lodash2["default"].forEach(this.refs, (function (val, ref) {
          var domNode = _reactDom2["default"].findDOMNode(_this2.refs[ref]);
        ...
        if (child.ref) {
          ...
          if (child.props.type == "checkbox" || child.props.type == "radio") {
            func = function () {
              ...
              formData[child.ref] = _reactDom2["default"].findDOMNode(_this3.refs[child.ref]).checked;
              _this3.setState({ formData: formData });
            };
          } else {
            func = function () {
              var formData = _this3.state.formData;
              formData[child.ref] = _reactDom2["default"].findDOMNode(_this3.refs[child.ref]).value;
              _this3.setState({ formData: formData });
            };
          }
